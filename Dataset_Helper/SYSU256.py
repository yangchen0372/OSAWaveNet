...
from Dataset_Helper.SYSU256_CFG import SYSU_DATASET_CFG
from Utlis.Tools import Tools

class SYSU256(Dataset):
    def __init__(self,flag='train'):
        ...
        '''
        data_root = os.path.join(SYSU_DATASET_CFG['data_root'],flag)
        ...
        self.FLAG = flag
        self.DATA_AUGMENT = SYSU_DATASET_CFG['transform'][flag]
        self.DATA_RESIZE = SYSU_DATASET_CFG['transform']['resize']
        self.DATA_NORMALIZE = SYSU_DATASET_CFG['transform']['normalize']
        self.DATA_TO_TENSOR = SYSU_DATASET_CFG['transform']['to_tensor']

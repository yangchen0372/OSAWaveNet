...
from Dataset_Helper.HRCUS256_CFG import HRCUS256_DATASET_CFG
from Utlis.Tools import Tools

class HRCUS256(Dataset):
    def __init__(self,flag='train'):
        ...
        '''
        data_root = os.path.join(HRCUS256_DATASET_CFG['data_root'],flag)
        ...
        self.FLAG = flag
        self.DATA_AUGMENT = HRCUS256_DATASET_CFG['transform'][flag]
        self.DATA_RESIZE = HRCUS256_DATASET_CFG['transform']['resize']
        self.DATA_NORMALIZE = HRCUS256_DATASET_CFG['transform']['normalize']
        self.DATA_TO_TENSOR = HRCUS256_DATASET_CFG['transform']['to_tensor']
